...
$('#applyChance').onclick=()=>{const p=Number(String($('#customChance').value).replace(',','.'));if(!Number.isFinite(p)||p<=0||p>MAX_CHANCE)return toast(`Введи шанс от 0,01% до ${MAX_CHANCE}%`);pickByChance(p)};
