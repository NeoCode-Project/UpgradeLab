...
## V12
Добавлены цены через Skinport API с резервным режимом, избранное, варианты износа, две цифры после запятой, дедупликация каталога и исправленный постоянный результат апгрейда.

## V13 fixes
- Target result ribbon no longer covers the skin name, wear, or price.
- A target cheaper than the stake cannot be selected.
- Quick target buttons only choose valid, more expensive skins.
- Reserve prices for knives, gloves, rare finishes, Howl, Dragon Lore and other premium skins are more realistic.
